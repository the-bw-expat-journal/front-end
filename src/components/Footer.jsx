...
import { FontAwesome, FaFacebook, FaTwitter, FaInstagram, FaGithub } from 'react-icons/fa';
...
const StyledFooter = styled.footer`
    ...
    .icons {
        ...
        &:hover {
            color: linear-gradient(45deg,#22a6b3,#30336b);
            background-color: linear-gradient(45deg,#22a6b3,#30336b);
            transform: scale(1.5);
        }
    }
